...
config, never from a value hard-coded here (see ``axqua.prepare_steady_inputs``).
...
Run: mamba run -n axqua-env python cases/<your-case>/preprocessing.py
"""
...
def main() -> None:
    ...
    # so it already exists in the produced axqua-case/ tree after preprocessing
    ...
    if art.hbc_config:
        ...
        print("  HBC config: skipped (ground-truth data do not match; see axqua.log)")
