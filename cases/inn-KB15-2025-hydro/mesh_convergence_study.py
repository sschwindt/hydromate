...
Run: mamba run -n hydromate-env python cases/inn-KB15-2025-hydro/mesh_convergence_study.py
     mamba run -n hydromate-env python cases/inn-KB15-2025-hydro/mesh_convergence_study.py mode='auto-refinement'
"""
