...
(``axqua.flux_convergence``, reading the solver listing with
``axqua.sortie``). It writes four files into the simulation folder -- ``extracted-fluxes.csv`` + ``flux-convergence.png`` (per-boundary
