...
Run: mamba run -n hydromate-env python cases/ering-revised/mesh_convergence_study.py
     mamba run -n hydromate-env python cases/ering-revised/mesh_convergence_study.py mode='auto-refinement'
"""
