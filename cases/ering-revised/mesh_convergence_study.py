...
Run: mamba run -n axqua-env python cases/ering-revised/mesh_convergence_study.py
     mamba run -n axqua-env python cases/ering-revised/mesh_convergence_study.py mode='auto-refinement'
"""
