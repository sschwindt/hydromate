...
aXqua is three things that can each be used without the others: a **model builder**, a **job runner**, and a **QGIS plugin**. This page explains how they fit together and, more usefully, *why* the seams are where they are.
