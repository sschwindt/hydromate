...
Being in Processing at all is worth it for one reason: it makes axqua scriptable from
...
class AxquaProvider(QgsProcessingProvider):
    ...
    def longName(self) -> str:              # noqa: N802 - QGIS naming
        return "aXqua (TELEMAC / OpenFOAM)"

    def icon(self):
        return icon("axqua.svg")
