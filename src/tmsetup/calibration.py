...
and BAL settings declared in the tmsetup config.
"""
...
from tmsetup import hydraulics
...
def emit_hbc_config(cfg: Config, calibration_csv: Path | None) -> Path:
    ...
    text = f'''"""HydroBayesCal TELEMAC config generated by tmsetup for case '{cfg.name}'.
