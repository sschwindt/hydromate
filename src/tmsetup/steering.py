...
from tmsetup.boundary import LiquidBoundary
...
def write_friction_tbl(cfg: Config) -> Path:
    ...
    lines = [
        "* Friction data file generated by tmsetup",
...
def write_cas(cfg: Config, liquids: list[LiquidBoundary],
    ...
    lines: list[str] = [
        "/" + "-" * 68,
        f"/ TELEMAC2D steering file generated by tmsetup for case '{cfg.name}'",
        f"/ regime: {h.regime}",
        "/" + "-" * 68,
...
def write_gaia_cas(cfg: Config) -> Path | None:
    ...
    lines = [
        "/ GAIA steering file generated by tmsetup",
