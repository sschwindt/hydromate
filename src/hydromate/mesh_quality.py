...
:mod:`hydromate.solvers.telemac.mesh_quality`.

Kept because ``hydromate.mesh_quality`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import mesh_quality as _impl
