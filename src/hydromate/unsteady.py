...
:mod:`hydromate.solvers.telemac.unsteady`.

Kept because ``hydromate.unsteady`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import unsteady as _impl
