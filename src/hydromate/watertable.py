...
:mod:`hydromate.fortran`). The bar's saturated zone is therefore bounded by two known
...
def _samples_from_lines(cfg, mesh, surface, overrides):
    ...
    from hydromate.boundary import _internal_sign
...
def _samples_from_zone(cfg, mesh, surface, overrides, *, band: float = 10.0):
    ...
    from hydromate.steering import _centerline_arclength
