...
:mod:`hydromate.solvers.telemac.watertable`.

Kept because ``hydromate.watertable`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import watertable as _impl
