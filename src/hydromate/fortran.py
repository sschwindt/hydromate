...
:mod:`hydromate.solvers.telemac.fortran`.

Kept because ``hydromate.fortran`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import fortran as _impl
