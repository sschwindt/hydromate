...
An answer *file* is also honoured, which is what lets a future ``hydromate answer JOB_ID
...
log = logging.getLogger("hydromate.jobs.interaction")

__all__ = ["PolicyAsk", "classify"]

#: Prompt text is matched loosely on purpose. These are hydromate's own prompts, so the
