...
:mod:`hydromate.solvers.telemac.wetting`.

Kept because ``hydromate.wetting`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import wetting as _impl
