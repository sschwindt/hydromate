...
:mod:`hydromate.solvers.telemac.pipeline`.

Kept because ``hydromate.pipeline`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import pipeline as _impl
