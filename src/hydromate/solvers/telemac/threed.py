...
* **Turbulence** - the same quality-checked selection as 2D
  (:func:`hydromate.steering.select_turbulence_model`), mapped onto the TELEMAC-3D
...
from hydromate.solvers.telemac.steering import TURB_NAMES, _global_friction, select_turbulence_model
