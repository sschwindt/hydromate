...
from hydromate import calibration, dem, hydraulics
from hydromate.solvers.telemac import boundary, fortran, mesh, steering
...
# hydromate.hydraulics; re-exported here (and under its old private spelling)
# because this module published it.
from hydromate.hydraulics import resolve_outflow_wse  # noqa: E402
