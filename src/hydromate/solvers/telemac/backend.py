...
from hydromate.core import errors
from hydromate.core.capabilities import Capability
from hydromate.core.registry import BaseBackend
from hydromate.jobs.results import STYLE_DEPTH, STYLE_VELOCITY

log = logging.getLogger("hydromate.solvers.telemac.backend")
...
class TelemacBackend(BaseBackend):
    ...
    def check_environment(self, cfg) -> bool:
        ...
        ``hydromate status --check-env`` where a broken install is information, not a
        crash.
        """
    ...
    def _build_case(self, cfg, *, ctx: Any = None, discharge: float | None = None,
        ...
        from hydromate.solvers.telemac import pipeline
    ...
    def _build_3d(self, cfg, *, ctx: Any = None, hydrostatic_steps: int | None = None,
        ...
        from hydromate.solvers.telemac.threed import build_3d_cases
        kwargs: dict[str, Any] = {}
    ...
    def _build_unsteady(self, cfg, *, ctx: Any = None, mode_3d: bool = False,
        ...
        from hydromate.solvers.telemac.unsteady import (build_unsteady_3d_case,
                                                        build_unsteady_case)
        if mode_3d:
    ...
    def _mesh_convergence(self, cfg, *, ctx: Any = None, discharge: float | None = None,
        ...
        from hydromate.convergence import ratio_levels, run_mesh_convergence
        from hydromate.workflow import prepare_steady_inputs
    ...
    def _vertical_convergence(self, cfg, *, ctx: Any = None,
                              ...
                              **_ignored):
        from hydromate.vertical_convergence import run_vertical_convergence
    ...
    def postprocess(self, cfg, ctx: Any = None):
        ...
        """
        from hydromate.jobs.model import JobKind
        ...
        from hydromate.solvers.telemac.flux_convergence import analyze_flux_convergence
    ...
    def _wetting_reports(cfg, ctx: Any) -> None:
        ...
        """
        from hydromate.workflow import report_wetting
        try:
            report_wetting(cfg)
...
def _sink_for(ctx: Any, name: str):
    ...
    if ctx is None:
        return None
    from hydromate.jobs.events import TeeSink, TextLogSink
