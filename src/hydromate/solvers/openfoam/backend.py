...
log = logging.getLogger("hydromate.solvers.openfoam.backend")
...
class OpenFoamBackend(BaseBackend):
    ...
    def build(self, cfg, capability: Capability | None = None, *, ctx: Any = None,
        ...
        *seed* is the 2D result to hotstart from, supplied by the caller. When it is
        ...
        """
        from hydromate.solvers.openfoam import case as of_case
        from hydromate.solvers.openfoam.hotstart import load_hotstart
    ...
    def postprocess(self, cfg, ctx: Any = None):
        ...
        """
        from hydromate.solvers.openfoam import report
        from hydromate.solvers.openfoam.runtime import OpenFoamRuntime
