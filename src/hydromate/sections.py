...
:mod:`hydromate.solvers.telemac.sections`.

Kept because ``hydromate.sections`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import sections as _impl
