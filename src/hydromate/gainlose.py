...
:mod:`hydromate.solvers.telemac.gainlose`.

Kept because ``hydromate.gainlose`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import gainlose as _impl
