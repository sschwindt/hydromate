...
:mod:`hydromate.solvers.telemac.flux_convergence`.

Kept because ``hydromate.flux_convergence`` was the published import path before the TELEMAC
...
from hydromate.solvers.telemac import flux_convergence as _impl
