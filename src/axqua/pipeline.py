...
:mod:`axqua.solvers.telemac.pipeline`.

Kept because ``axqua.pipeline`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import pipeline as _impl
