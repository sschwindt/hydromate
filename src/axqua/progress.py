...
stdout as the run marches. axqua normally captures that silently, so a solver
...
class ProgressBar:
    ...
    (:class:`axqua.solvers.openfoam.runtime.OpenFoamProgress`), which parses a completely
...
class SolverProgress:
    ...
    def __init__(self, total_time: float, *, width: int = 40,
        ...
        # axqua.jobs.events). *echo* off suppresses the terminal rendering for a
