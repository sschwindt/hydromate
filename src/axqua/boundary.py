...
:mod:`axqua.solvers.telemac.boundary`.

Kept because ``axqua.boundary`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import boundary as _impl
