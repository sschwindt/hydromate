...
maths from :mod:`axqua.core`.

Every backend exposes a ``spec`` module holding a
:class:`~axqua.core.registry.BackendSpec`. That module is **import-light on
purpose**: it is what ``axqua status`` and a future QGIS plugin read to learn what
