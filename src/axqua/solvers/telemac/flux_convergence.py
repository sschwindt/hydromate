...
This module is **self-contained**: the listing is parsed by :mod:`axqua.solvers.telemac.sortie`
...
GPL-3 ``postel`` code, which cannot be vendored into BSD-3-licensed axqua; and
...
from axqua.solvers.telemac.sortie import Sortie, latest_sortie, processor_sorties, read_sortie
