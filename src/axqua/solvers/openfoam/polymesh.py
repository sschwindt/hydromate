...
This is the OpenFOAM counterpart of :mod:`axqua.core.selafin`: axqua writes the
...
(:mod:`axqua.solvers.openfoam.quality`) rather than assumed away.
  ...
  \\\\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox
   \\\\    /   O peration     | Website:  https://openfoam.org
    \\\\  /    A nd           | Version:  {version}
     \\\\/     M anipulation  | Written by axqua
\\*---------------------------------------------------------------------------*/
FoamFile
{{
    format      {fmt};
...
def validate(mesh: PolyMesh) -> list[str]:
    ...
    skewness, volume) is :mod:`axqua.solvers.openfoam.quality`'s job.
    """
    problems: list[str] = []
