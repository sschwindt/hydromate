...
:mod:`axqua.solvers.telemac.fortran`.

Kept because ``axqua.fortran`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import fortran as _impl
