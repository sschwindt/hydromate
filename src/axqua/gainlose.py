...
:mod:`axqua.solvers.telemac.gainlose`.

Kept because ``axqua.gainlose`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import gainlose as _impl
