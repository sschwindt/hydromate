...
:mod:`axqua.solvers.telemac.threed`.

Kept because ``axqua.threed`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import threed as _impl
