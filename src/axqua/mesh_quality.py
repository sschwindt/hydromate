...
:mod:`axqua.solvers.telemac.mesh_quality`.

Kept because ``axqua.mesh_quality`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import mesh_quality as _impl
