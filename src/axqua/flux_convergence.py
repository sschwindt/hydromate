...
:mod:`axqua.solvers.telemac.flux_convergence`.

Kept because ``axqua.flux_convergence`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import flux_convergence as _impl
