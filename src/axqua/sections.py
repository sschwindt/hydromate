...
:mod:`axqua.solvers.telemac.sections`.

Kept because ``axqua.sections`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import sections as _impl
