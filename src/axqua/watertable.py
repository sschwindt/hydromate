...
:mod:`axqua.solvers.telemac.watertable`.

Kept because ``axqua.watertable`` was the published import path before the TELEMAC
...
from axqua.solvers.telemac import watertable as _impl
